...
assert_matches "$lib" '(?m)^trigger_submit_plan_hitl_review_and_synthesize\(\) \{[[:blank:]]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+return_to_campaign_session_detail[[:blank:]]*\n^[[:blank:]]+story_session_land[^\n]*\n^[[:blank:]]+type(?:_text|_slow) "[^"\n]*Synthesize approved evidence from \$\{positioning_task_id\}, \$\{proof_task_id\}, \$\{readiness_task_id\}, and \$\{handoff_task_id\}[^"\n]*"[[:blank:]]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+type(?:_text|_slow) "[^"\n]*words PH AUDIT SYNTHESIS, then a colon, one space, and the handoff task id \$\{handoff_task_id\}[^"\n]*"[[:blank:]]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+press_key Enter[[:blank:]]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+story_hard_proof[^\n]*"PH AUDIT SYNTHESIS: \$\{handoff_task_id\}"[^\n]*$' \
  'PH audit synthesis prompt names all four ids and proof is handoff-correlated'
assert_matches "$lib" '(?m)^trigger_submit_plan_hitl_review_and_synthesize\(\) \{[[:blank:]]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+land_plan_inspector_for_task "\$positioning_task_id"[^\n]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+story_plan_inspector_result_hard_proof[^\n]*"PH POSITIONING FINDING:"[^\n]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+press_key a[[:blank:]]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+[^\n]*"Decision: Approve"[^\n]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+story_plan_inspector_result_hard_proof[^\n]*"PH PROOF FINDING:"[^\n]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+press_key d[[:blank:]]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+[^\n]*"Decision: Reject"[^\n]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+press_key R[[:blank:]]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+story_plan_inspector_result_hard_proof[^\n]*"SOURCE:"[^\n]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+story_plan_inspector_result_hard_proof[^\n]*"WINDOW:"[^\n]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+story_plan_inspector_result_hard_proof[^\n]*"RECOMMENDATION:"[^\n]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+press_key a[[:blank:]]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+[^\n]*"Decision: Approve"[^\n]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+story_plan_inspector_result_hard_proof[^\n]*"PH READINESS FINDING:"[^\n]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+press_key a[[:blank:]]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+[^\n]*"Decision: Approve"[^\n]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+story_hard_proof[^\n]*"\$handoff_task_id"[^\n]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+story_plan_inspector_result_hard_proof[^\n]*"PH HANDOFF FINDING:"[^\n]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+press_key a[[:blank:]]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+[^\n]*"Decision: Approve"[^\n]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+return_to_campaign_session_detail[[:blank:]]*\n(?:^[[:blank:]]+.*\n|^\n)*?^[[:blank:]]+story_hard_proof[^\n]*"PH AUDIT SYNTHESIS: \$\{handoff_task_id\}"[^\n]*$' \
  'PH audit campaign order reaches four approvals, one proof retry, and handoff-correlated synthesis'
