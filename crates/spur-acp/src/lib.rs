...
pub use crate::domain::events::{
    Artifact, DiffSummary, FileTouchKind, LifecycleState, LoadOutcome, PlanSnapshot,
    PlanSnapshotCounts, PlanSnapshotTask, ReviewDecision, ReviewKind, ReviewPayload, Role,
};
pub use domain::{
