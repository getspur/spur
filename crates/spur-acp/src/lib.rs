...
pub use agent_client_protocol::schema::v1::{
    ...
    CreateTerminalResponse, CurrentModeUpdate, DeleteSessionRequest, DeleteSessionResponse, Diff,
    EmbeddedResource, EmbeddedResourceResource, ExtNotification, ExtRequest, ExtResponse,
    ...
    SessionCloseCapabilities, SessionConfigGroupId, SessionConfigId, SessionConfigKind,
