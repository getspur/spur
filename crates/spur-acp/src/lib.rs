...
pub use agent_client_protocol::schema::v1::{
    ...
    SetSessionModeRequest, SetSessionModeResponse, StopReason, Terminal, TerminalExitStatus,
    TerminalId, TerminalOutputRequest, TerminalOutputResponse, TextContent, TextResourceContents,
    ToolCall, ToolCall as AcpToolCall, ToolCallContent, ToolCallId, ToolCallLocation,
    ToolCallStatus, ToolCallUpdate, ToolCallUpdate as AcpToolCallUpdate, ToolCallUpdateFields,
