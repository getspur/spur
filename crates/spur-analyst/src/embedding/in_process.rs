...
#[cfg(feature = "embed")]
use spur_graph::{
    embedding_query_text_for_model, load_embedding_model, EmbeddingModelSelection, EMBED_MODEL_ENV,
};
...
pub(crate) fn load_embed_model(
    ...
    load_embedding_model(embedding_model, false).map_err(|error| error.to_string())
}
