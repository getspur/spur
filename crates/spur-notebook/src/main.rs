...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            spur_notebook::commands::start_kernel,
            spur_notebook::commands::restart_kernel,
            jute::commands::stop_kernel,
            spur_notebook::commands::run_cell,
            jute::chat_commands::chat_agents_list,
            jute::chat_commands::chat_turn,
            jute::chat_commands::chat_sessions_list,
            jute::chat_commands::chat_session_modes_list,
            jute::chat_commands::chat_switch_session,
            jute::chat_commands::chat_set_session_mode,
